...
public abstract class FragmentCategoryBinding extends ViewDataBinding {
  ...
  @NonNull
  public final ShimmerFrameLayout categoryListLoading;
  ...
  protected FragmentCategoryBinding(Object _bindingComponent, View _root, int _localFieldCount,
      RecyclerView categoryList, ShimmerFrameLayout categoryListLoading, Guideline guideline2,
      View include4, View include5, View view) {
    super(_bindingComponent, _root, _localFieldCount);
    this.categoryList = categoryList;
    this.categoryListLoading = categoryListLoading;
